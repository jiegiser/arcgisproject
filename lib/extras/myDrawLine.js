...
define([ "dojo/_base/declare",
 ...
 var myDraw = declare(null,{
     options:{
      ...
      startup: function () {
          on(dom.byId("gdEnd"), "click", lang.hitch(this, function () {
              this.FuncID = 0;
          }));

          //管道添加
          on(dom.byId("gdAdd"), "click", lang.hitch(this, function () {
              this.FuncID = 1;
          ...
          on(dom.byId("gdProperty"), "click", lang.hitch(this, function () {
              this.FuncID = 2;
          }));

          on(dom.byId("gdEdit"), "click", lang.hitch(this, function () {
              this.FuncID = 3;

          }));

          on(dom.byId("gdDelete"), "click", lang.hitch(this, function () {
              this.FuncID = 4;
      ...
      _editGraphic: function () {
          if (this.options.featureLayer.isEditable) {
              ...
              var guanjing = dom.byId("txtComment").value;

              switch(this.FuncID){
                  case 1:
                      this.tempGraphic.setAttributes({ "name": Name, "guanjing": guanjing });
                      this.options.featureLayer.applyEdits([this.tempGraphic], null, null);
                      break;
                  case 2:
                      this.tempGraphic.attributes["name"] = Name;
                      this.tempGraphic.attributes["guanjing"] = guanjing;
      ...
      _featureClick: function (evt) {
          ...
          var guanjing = evt.graphic.attributes["guanjing"];
          ...
          switch (this.FuncID) {
              ...
              case 2:
                  ...
                  dom.byId("txtComment").value = guanjing;
      ...
      _addToMap: function (geometry) {
        ...
        var polyLine = new SimpleLineSymbol();
        this.tempGraphic = new Graphic(geometry);
        this.options.map.graphics.add(new Graphic(geometry, polyLine));
