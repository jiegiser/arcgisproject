require(["dojo/parser", "dijit/registry", 'dojo/on', "esri/map", "esri/geometry/Extent", "esri/SpatialReference", "esri/InfoTemplate", "esri/layers/ArcGISTiledMapServiceLayer", "esri/graphic", "esri/toolbars/draw",
    ...
    function (parser, registry, on, Map, Extent, SpatialReference, InfoTemplate, ArcGISTiledMapServiceLayer, Graphic, Draw,
        ...
        var streetMap = new ArcGISTiledMapServiceLayer("http://192.168.1.88:6080/arcgis/rest/services/JYG1/JCDL/MapServer");
        ...
        resultTemplate.setContent("标识码： ${BSM},<br/>YSDM： ${要素代码},<br/>XZQMC： ${行政区名称}");
        ...
        // 初始化查询任务与查询参数   
        var queryTask = new QueryTask("http://192.168.1.88:6080/arcgis/rest/services/JYG1/JCDL/MapServer/1");
        queryTask.on("complete", showResult);
        var query = new Query();
        query.returnGeometry = true;
        query.outFields = ["BSM", "YSDM", "XZQMC", "JSMJ"];
        ...
        function setGridHeader() {
            var layout = [
                 { field: 'BSM', name: '标识码', width: "100px", headerStyles: "text-align:center;" },
                 { field: 'YSDM', name: '要素代码', width: "100px", headerStyles: "text-align:center;" },
                 { field: 'XZQMC', name: '行政区名称', width: "100px", headerStyles: "text-align:center;" }
            ];
